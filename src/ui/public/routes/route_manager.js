...
export default function RouteManager() {
  ...
  self.run = ['$rootScope', '$location', '$routeParams', '$route', '$injector', function($rootScope, $location, $routeParams, $route, $injector) {
      ...
      //   console.log('route have already changed ：'+$location.path()+",routeParams:"+$routeParams);
      //   console.log(current,previous);
      // }); 

      $rootScope.$on('$routeUpdate',function(event,current){
        //tab的状态的改变
        console.log('route have already changed ：'+$location.path()+",routeParams:");
